...
%>
<p class="notice">아이콘을 눌러 연동하세요.</p>
   <table class="tableSocial">
      <tr>
         ...
         <td>
            <button class="btn-grey"  id="kakaoUnlink"
    ...
    <%=linkedAccounts.getOrDefault("naver", false) ? "pointer-events: none; opacity: 0.5;" : ""%>">
         ...
         <td>
            <button class="btn-grey"  id="naverUnlink"
      ...
      <tr>
         ...
         <td>
            <button class="btn-grey"  id="googleUnlink"
...
<c:choose>
	...
	<button class="btn-green" name="btn-makeInfo" id="btn-makeInfo" onclick="location.href='${ctx}/userInfo.do'">인포만들기</button>
	</c:when>
	<c:otherwise>
